...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  csv_line = predicted_color + "," + str (predicted_direction) + "," + str(predicted_speed) + "," +  str(localtime[:3]) + "," +  str(localtime[4:7]) + "," +  str(localtime[8:10]) + "," +  str(localtime[11:13]) + "," +  str(localtime[14:16]) + "," +  str(localtime[17:19]) # csv line created
